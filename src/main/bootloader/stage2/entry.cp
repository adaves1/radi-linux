...
class .entry {
  ...
  class .entry extends {
    ...
    DEF << move g_BootDrive : REG dl;
    DEF << move g_BootPartitionOff : REG si;
    DEF << move g_BootPartitionSeg : REG di;

    DEF << move REG ax : REG ds;
    DEF << move REG ss : REG ax;
    DEF << move REG sp : HEX:0xFFF0;
    DEF << move REG bp : REG sp;
